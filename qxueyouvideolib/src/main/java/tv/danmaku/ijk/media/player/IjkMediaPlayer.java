...
public final class IjkMediaPlayer extends AbstractMediaPlayer {
    ...
    public void setDataSource(String path)
            throws IOException, IllegalArgumentException, SecurityException, IllegalStateException {
        mDataSource = path;
        _setDataSource(path, null, null,mEncryptValues,mEncrypt);
    }
    ...
    private native void _setDataSource(String path, String[] keys, String[] values,String mEncryptValues,int encrypt)
            throws IOException, IllegalArgumentException, SecurityException, IllegalStateException;
    ...
    public void setEncrypt(int encrypt,String mDataSource) throws IllegalStateException {
  //      _setEncrypt(encrypt);
//        mEncrypt = encrypt;
//        mEncryptValues = mDataSource;
        mEncrypt = 0;
        mEncryptValues = "qxueyou";
        Log.e(TAG, "setEncrypt: encrypt 222222222= "+encrypt+"  values = "+mEncryptValues );
